...
git_sparse_clone main https://github.com/kiddin9/openwrt-packages luci-app-advancedsetting
git_sparse_clone main https://github.com/kiddin9/openwrt-packages luci-app-filebrowser
